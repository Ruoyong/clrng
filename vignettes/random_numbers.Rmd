...
# runifGpu: generate uniform random numbers parallely on a GPU
```{r unif, eval=TRUE}
...
# rnormGpu: generate standard normal random numbers parallely on a GPU
```{r rnormGpu}
...
# rexpGpu: generate exponential random numbers parallely on a GPU 
```{r exp}
## create sreams on a GPU

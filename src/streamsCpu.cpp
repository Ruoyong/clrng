...
// // [[Rcpp::export]]
// Rcpp::IntegerMatrix  createStreamsCpu2Backend(
...
//   
//   static clrngMrg31k3pStreamCreator streamCreatorHere = {
//     BASE_CREATOR_STATE_FromUser,
//     BASE_CREATOR_STATE_FromUser,
//     BASE_CREATOR_JUMP_MATRIX_1,
//     BASE_CREATOR_JUMP_MATRIX_2
//   };
...
Rcpp::IntegerMatrix  createStreamsCpuBackend(
  ...
  if (!initial_.isNotNull()){
    streams = clrngMrg31k3pCreateStreams(&defaultStreamCreator, n[0], &streamBufferSize, &err);//line 299 in mrg31k3p.c
     ...
     clrngMrg31k3pStreamState  BASE_CREATOR_STATE_FromUser2 = SetBaseCreatorState(initial);
     //Rcpp::Rcout << BASE_CREATOR_STATE_FromUser  << std::endl;
       #undef BASE_CREATOR_STATE
       #define BASE_CREATOR_STATE_FromUser BASE_CREATOR_STATE_FromUser2
...
// // [[Rcpp::export]]
// Rcpp::IntegerMatrix  createStreamsCpuDefaultBackend(
//     Rcpp::IntegerVector n){  //Rcpp::Nullable<Rcpp::IntegerVector>
// 
// 
//   Rcpp::IntegerMatrix result=Rcpp::IntegerMatrix(n[0], 12L);
// 
...
//   clrngStatus err;
// 
//   clrngMrg31k3pStream* streams = clrngMrg31k3pCreateStreams(&defaultStreamCreator, n[0],
//                                                             &streamBufferSize, &err);//line 299 in mrg31k3p.c
// 
// 
//   convertclRngMat(streams, result);
